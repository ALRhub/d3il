...
from agents.models.robomimic.utils.dataset import SequenceDataset
from agents.models.robomimic.envs.env_base import EnvBase
from agents.models.robomimic.envs.wrappers import EnvWrapper
from agents.models.robomimic.algo import RolloutPolicy
...
def get_exp_dir(config, auto_remove_exp_dir=False):
    ...
    if not os.path.isabs(base_output_dir):
        # relative paths are specified relative to agents.models.robomimic module location
        base_output_dir = os.path.join(agents.models.robomimic.__path__[0], base_output_dir)
